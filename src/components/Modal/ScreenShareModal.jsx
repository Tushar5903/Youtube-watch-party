...
export const ScreenShareModal = ({ closeModal, startScreenShare }) => {
  ...
  return (
    <Modal
      ...
      size="auto"
    >
      <div style={{ marginBottom: "12px" }}>You're about to share your screen.</div>
      ...
      <Table striped withTableBorder>
        ...
        <Table.Tbody>
          ...
          <Table.Tr>
            <Table.Td fw={500}>Latency</Table.Td>
            <Table.Td>{`<1s`}</Table.Td>
            <Table.Td>{`<1s`}</Table.Td>
          </Table.Tr>
          <Table.Tr>
            <Table.Td fw={500}>Recommended Max Viewers</Table.Td>
            <Table.Td>5</Table.Td>
            <Table.Td>20</Table.Td>
          </Table.Tr>
          <Table.Tr>
            <Table.Td fw={500}>Recommended Upload Speed</Table.Td>
